...
exports.default = {
     ...
     * @returns {string}
     */
    getPassphrase: function getPassphrase() {
...
exports.default = {
     ...
     * @param url {string}
     */
    focusOrCreateTab: function focusOrCreateTab(url) {
    ...
    hasPassphraseOrShowUnlock: function hasPassphraseOrShowUnlock() {
        if (!_storage2.default.getPassphrase()) {
...
exports.default = {
    ...
    show: function show(title, message) {
        var icon = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '/static/img/icon-64.png';
...
var _editable = __webpack_require__(7);
...
var _storesite = __webpack_require__(23);

var _storesite2 = _interopRequireDefault(_storesite);
...
chrome.contextMenus.create({
    ...
    "onclick": function onclick() {
        _tab2.default.focusOrCreateTab(chrome.extension.getURL("views/start.html#/"));
    }
});
...
webRequest.onBeforeRequest.addListener(_post2.default.post, { urls: ["<all_urls>"] }, ["requestBody"]);
...
exports.default = function (info, tab) {
    // The passphrase needs to be unlocked before we can insert an element
    if (!_tab2.default.hasPassphraseOrShowUnlock()) {
        return;
    }
    ...
    try {
        var host = _url2.default.parse(url).host;

        // Handle
        _message2.default.sendMessage({
            task: 'elements',
            url: chrome.extension.getURL("views/start.html#/insert/" + encodeURI(host))
        });
    } catch (err) {
        console.log('Could not take care of request ' + url);
        _notification2.default.show('Error loading', 'Loading password choose failed: ' + JSON.stringify(err));
    }
};
...
exports.default = function (info, tab) {
    ...
    try {
        ...
        _notification2.default.show('Error loading', 'Loading Generator failed: ' + JSON.stringify(err));
    }
};
...
exports.default = function (info, tab) {
    ...
    if (!selectedText) {
        _notification2.default.show('No text selected!', 'You have to select the text you want to store!');

        return;
    }

    var passphrase = _storage2.default.getPassphrase();
    ...
    var note = {
        ...
        content: (0, _encrypt2.default)(selectedText, passphrase),
        status: 1
    };

    // Send Post TODO outsource to API wrapper
    var url = _storage2.default.getApiUrl() + '/api/v1/notes';
    ...
    axios({
        method: 'post',
        url: url,
        headers: { 'api-key': _storage2.default.getApiKey() },
        data: JSON.stringify(note)
    }).then(function (response) {
        _notification2.default.show('Secure Note saved', 'Your secure note has been successfully stored in your Vault.');
    }).catch(function (error) {
        _notification2.default.show('Error saving note', 'Your secure note could not be stored.');
        console.log(error);
    });
};
...
var _encrypt = __webpack_require__(10);
...
exports.default = function (clearText, passphrase) {
    var bs = 32;
    var hash = _jsSha2.default.create();

    // We need the digest
    var key = hash.update(passphrase).digest();

    var clearBytes = _aesJs2.default.utils.utf8.toBytes(clearText);

    // We need a min length
    var fillCount = bs - clearBytes.length % bs;
    var char = String.fromCharCode(fillCount);
    ...
    clearBytes = _aesJs2.default.utils.utf8.toBytes(clearText);
    ...
    var cryptedBytes = aesCbc.encrypt(clearBytes);

    // Add the IV in the beginning (our salt)
    var withIv = new Uint8Array(iv.length + cryptedBytes.length);
    withIv.set(iv);
...
var _aesJs = __webpack_require__(15);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(17), __webpack_require__(5), __webpack_require__(18)(module)))
...
var _formdata = __webpack_require__(21);
...
exports.default = {
     ...
     * @param details
     */
    post: function post(details) {
        var handledMethods = ['POST', 'PUT'];
        ...
        if (!_formdata2.default.containsPassword(details.requestBody.formData)) {
            return;
        }

        // We temporary store the value, until the user decides what to do
        _storage2.default.set('lastPostRequest', JSON.stringify(details));
    },
    ...
    ready: function ready() {
        if (!_storage2.default.get('lastPostRequest')) {
            return;
        }

        try {
            var details = JSON.parse(_storage2.default.get('lastPostRequest'));

            var host = _url2.default.parse(details.url).host;
            ...
            _storage2.default.set('lastPostRequest', '');
        }
    }
};
...
exports.default = {
     ...
     * @returns {*}
     */
    containsPassword: function containsPassword(formData) {
        for (var key in formData) {
            if (_constants.PASSWORD_REGEX.test(key)) {
                return key;
            }
        }
...
var USER_REGEX = exports.USER_REGEX = /user|benutzer|login|email/gi;
var PASSWORD_REGEX = exports.PASSWORD_REGEX = /pass|pw|passwort/gi;
...
exports.default = function (siteUrl) {
    var website = {
        url: siteUrl,
        tags: '',
        status: 1
    ...
    // Send Post TODO outsource to API wrapper
    var url = _storage2.default.getApiUrl() + '/api/v1/sites';
    ...
    axios({
        ...
        _notification2.default.show('Website saved', 'The website URL has been saved.');
    }).catch(function (error) {
        _notification2.default.show('Error saving Website', 'Your website URL could not be stored.');
        console.log(error);
    });
};
