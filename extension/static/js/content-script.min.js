...
exports.default = {
    ...
    showIframe: function showIframe(element, iframeSrc) {
        // Hardcoded for now
        var elementPosition = { top: -35, right: 20 };
...
window.nowpass.store = new _Store2.default();
...
exports.default = function (params) {
    ...
    var result = (0, _UserData2.default)(params);
...
var _UserData = __webpack_require__(4);

var _UserData2 = _interopRequireDefault(_UserData);

var _PasswordData = __webpack_require__(8);
...
exports.default = function (params) {
    ...
    var preset = JSON.parse(login.form_data) || _common2.default[login.host];
...
var _DomSearch = __webpack_require__(6);
...
exports.default = {
    ...
    searchUser: function searchUser(params) {
        ...
        if (clickedElement.tag === 'INPUT' && clickedElement.type !== 'password') {
            ...
            var result = this.checkElement(clickedElement, _constants.USER_REGEX);
        ...
        if (clickedElement.tag === 'INPUT' && clickedElement.form) {
            ...
            for (var i = 0; i < _elements.length; i++) {
                var _result = this.checkElement(_elements[i], _constants.USER_REGEX);
        ...
        for (var _i = 0; _i < elements.length; _i++) {
            var _result2 = this.checkElement(elements[_i], _constants.USER_REGEX);
    ...
    searchPassword: function searchPassword(params) {
        ...
        if (clickedElement.tag === 'INPUT' && clickedElement.type === 'password') {
            // Chance of being the username
            var result = this.checkElement(clickedElement, _constants.PASSWORD_REGEX);
        ...
        if (clickedElement.tag === 'INPUT' && clickedElement.form) {
            ...
            for (var i = 0; i < _elements2.length; i++) {
                var _result3 = this.checkElement(_elements2[i], _constants.PASSWORD_REGEX);
        ...
        for (var _i2 = 0; _i2 < elements.length; _i2++) {
            var _result4 = this.checkElement(elements[_i2], _constants.PASSWORD_REGEX);
...
var Generator = function () {
    ...
    _createClass(Generator, [{
        ...
        key: 'insert',
        value: function insert(pass) {
            var clickedElement = window.nowpass.clickedElement || document.activeElement;
        ...
        value: function init() {
            ...
            chrome.runtime.onMessage.addListener(function (message, _, sendResponse) {
                if (message.task === 'storePopup') {
                    // Show storing iframe
                    _popup2.default.showIframe(null, message.url);
